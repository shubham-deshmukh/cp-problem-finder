...
export const UserDropdown: React.FC = () => {
  ...
  return (
    <div className="flex items-center gap-2.5">
      {isAdmin && (
        <span className="hidden sm:inline-flex items-center px-2 py-0.5 rounded-full text-[9px] font-bold tracking-wider uppercase bg-linear-to-r from-[#ffa116] via-[#ff9345] to-[#ff3d00] text-white shadow-xs select-none">
          Admin
        </span>
      )}
      <DropdownMenu>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col min-w-0">
                <div className="flex items-center gap-1.5 min-w-0">
                  ...
                  {isAdmin && (
                    <span className="inline-flex items-center px-1.5 py-0.2 rounded-full text-[8px] font-bold tracking-wider uppercase bg-primary/10 text-primary border border-primary/20 select-none shrink-0">
                      Admin
                    </span>
                  )}
                </div>
